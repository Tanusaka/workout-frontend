		...
		$.ajax({
				...
				success: function(data) {
					...
					$.each(data.sections, function(index, value) {
							...
							$('#kt_accordion_1').append('<div class="accordion-item"><h2 class="accordion-header" id="kt_accordion_1_header_'+value.id+'"><button class="accordion-button fs-4 fw-semibold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#kt_accordion_1_body_'+value.id+'" aria-expanded="false" aria-controls="kt_accordion_1_body_'+value.id+'"><div style="width:85%;" class="d-flex align-items-center"><div class="symbol symbol-45px me-5"><img src="assets/media/avatars/300-14.jpg" alt="" /></div><div class="d-flex justify-content-start flex-column"><a href="#" class="text-dark fw-bold text-hover-primary fs-6">Section Name Goes Here</a><span class="text-muted fw-semibold text-muted d-block fs-7">05 Programs | 60 minutes</span></div></div><div style="float: right; margin-left:5%;"><a href="" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_add_lessons_deatils"><i class="ki-duotone ki-plus fs-2"><span class="path1"></span><span class="path2"></span></i></a></div><div style="float: right; margin-left:2%; margin-right:2%"><a href="" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_add_new_course_deatils"><i class="ki-duotone ki-pencil fs-2"><span class="path1"></span><span class="path2"></span></i></a></div></button></h2><div id="kt_accordion_1_body_'+value.id+'" class="accordion-collapse collapse" aria-labelledby="kt_accordion_1_header_'+value.id+'" data-bs-parent="#kt_accordion_1"><div class="accordion-body" id="accordion-body_' + value.id+'">.....</div></div></div>');

								// $('#kt_accordion_1').append('<div class="accordion-item"><h2 class="accordion-header" id="kt_accordion_1_header_3"><button class="accordion-button fs-4 fw-semibold collapsed" type="button" data-bs-toggle="collapse" ><div style="width:85%;" class="d-flex align-items-center"><div class="symbol symbol-45px me-5"><img src="assets/media/avatars/300-14.jpg" alt="" /></div><div class="d-flex justify-content-start flex-column"><a href="#" class="text-dark fw-bold text-hover-primary fs-6">' + value.title + '</a><span class="text-muted fw-semibold text-muted d-block fs-7">05 Programs | 60 minutes</span></div></div><div style="float: right; margin-left:5%;"><a href="" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_add_lessons_deatils"><i class="ki-duotone ki-plus fs-2"><span class="path1"></span><span class="path2"></span></i></a></div><div style="float: right; margin-left:2%; margin-right:2%"><a href="" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_add_new_course_deatils"><i class="ki-duotone ki-pencil fs-2"><span class="path1"></span><span class="path2"></span></i></a></div></button></h2><div id="kt_accordion_1_body_3" class="accordion-collapse collapse" aria-labelledby="kt_accordion_1_header_3" data-bs-parent="#kt_accordion_1"><div class="accordion-body" id="accordion-body_' + value.id + '" name="accordion-body_' + value.id + '">...</div></div></div>');

								$.each(value.contents, function(index2, value2) {
									$('#accordion-body_' + value.id).append('<div class = "overflow-auto pb-5" > <!--begin::Record--><div class="d-flex align-items-center border border-dashed border-gray-300 rounded px-7 py-3 mb-5" style="width:100%;"><!--begin::Title--><i class="las la-file-pdf fs-2x" style="margin-right:3%; "></i><span style="width:80%;" class="fs-5 text-dark text-hover-primary fw-semibold ">' + value2.title + '</span><!--end::Title--><!--begin::Progress--><div class=" pe-2"><span class="badge badge-light-primary">15:00 minutes</span></div><!--end::Progress--></div><!--end::Record--></div><div class="overflow-auto pb-5"><!--begin::Record--><div class="d-flex align-items-center border border-dashed border-gray-300 rounded px-7 py-3 mb-5" style="width:100%;"><!--begin::Title--><i class="las la-play-circle fs-2x" style="margin-right:3%; "></i><span style="width:80%;" class="fs-5 text-dark text-hover-primary fw-semibold ">Lesson name goes here</span><!--end::Title--><!--begin::Progress--><div class=" pe-2"><span class="badge badge-light-primary">15:00 minutes</span></div><!--end::Progress--></div><!--end::Record--></div>');
								});
								// $('#kt_accordion_1').append('<div class="accordion-item"><h2 class="accordion-header" id="kt_accordion_1_header_1"><button class="accordion-button fs-4 fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#kt_accordion_1_body_1" aria-expanded="true" aria-controls="kt_accordion_1_body_1"><div style="width:85%;" class="d-flex align-items-center"><div class="symbol symbol-45px me-5"><img src="assets/media/avatars/300-14.jpg" alt="" /></div><div class="d-flex justify-content-start flex-column"><a href="#" class="text-dark fw-bold text-hover-primary fs-6">Section Name Goes Here</a><span class="text-muted fw-semibold text-muted d-block fs-7">05 Programs | 55 minutes</span></div></div><div style="float:right; margin-left:5%;"><a href="/coursesdetails" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"><i class="ki-duotone ki-pencil fs-2"><span class="path1"></span><span class="path2"></span></i></a></div></button></h2><div id="kt_accordion_1_body_1" class="accordion-collapse collapse show" aria-labelledby="kt_accordion_1_header_1" data-bs-parent="#kt_accordion_1"><div class="accordion-body">');
